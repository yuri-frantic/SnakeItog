...
QT_MOC_LITERAL(1, 12, 14), // "inputSubmitted"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4), // "text"
QT_MOC_LITERAL(4, 33, 11) // "submitInput"

    },
    "InputDialog\0inputSubmitted\0\0text\0"
    "submitInput"
};
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->inputSubmitted((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputDialog::inputSubmitted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputDialog::inputSubmitted(const QString & _t1)
{
